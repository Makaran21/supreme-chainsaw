<script lang="ts">
	...
	let post = {
		...
		excerpt: 'Learn the most important principles for writing maintainable code that your team will love.',
		content: `
			<h2>Introduction</h2>
	...
	let comments = [
		{
			...
			content: 'Great article! The section about meaningful names really resonated with me. I\'ve been guilty of using single-letter variables too often.',
			...
			replies: [
				{
					...
					content: 'Thanks Sarah! It\'s one of the easiest wins for improving code quality. Even changing "x" to "userIndex" makes a huge difference.',
		...
		},
		{
			...
			content: 'The part about avoiding deep nesting is so important. I\'ve seen code with 6+ levels of nesting and it\'s a nightmare to debug.',
...
<div class="min-h-screen bg-background">
	<!-- Hero Section -->
	<div class="relative h-[400px] w-full overflow-hidden bg-gradient-to-b from-muted to-background">
		<img 
			src={post.coverImage} 
			alt={post.title}
		...
		<div class="absolute left-4 top-4">
			<Button variant="ghost" size="icon" href="/blog" class="bg-background/80 backdrop-blur-sm">
	...
	<!-- Main Content -->
	<div class="mx-auto max-w-4xl px-4 -mt-32 relative z-10">
		<Card class="shadow-xl">
			<CardContent class="p-8 md:p-12">
				...
				<!-- Engagement Stats -->
				<div class="flex items-center gap-6 mb-8 text-sm text-muted-foreground">
					<div class="flex items-center gap-2">
						<Heart class="h-4 w-4" />
							...
							<Card>
								<CardContent class="p-6">
									...
									{#if replyingTo === comment.id}
										<div class="ml-13 mt-4 space-y-2">
											<Textarea
