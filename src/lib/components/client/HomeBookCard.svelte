...
<a
	{href}
	class="group sanimate-[fadeIn_0.2s_ease-out] block cursor-pointer overflow-hidden rounded-xl border border-border bg-card duration-200 hover:-translate-y-0.5 hover:shadow-md"
